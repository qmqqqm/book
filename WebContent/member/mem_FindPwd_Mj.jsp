...
<div class="rab">
	...
	<!--메인  -->
	   ...
	   <hr>
	   <br>
	    <form name="frm" id="frm" action="<%=request.getContextPath()%>/member/findPwd.book" method="post">
		<table >
	   		<tr>
	        <th class="index">ID</th>
		        <td><input class="intext" type="text" name="id" id="id"  placeholder="ID를 입력하세요">
		        </td>        
		    </tr>
		    <tr>
		    ...
		    <tr>
		    	<td class="bottom">
		    	 	<input class="bottomMenu"  type="submit" value="비밀번호 찾기" >
		    	 </td>
		    </table>
		    </form>
		    <table>
