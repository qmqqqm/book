...
<div class="rab">
	...
	<hr/>
			<%-- form --%>
					<form class="form-horizontal" action="<%=request.getContextPath()%>/review/update.book"  method="post">
						<table >
							<tr>
						...
						<tr>
							<th>내용:</th>
							<td>
								<textarea class="form-control" rows="15" cols="100"	placeholder="review_content" name="review_write" id="review_write">${review_write}</textarea>
							</td>
							</tr>
							<tr>
							<td colspan="2">			
