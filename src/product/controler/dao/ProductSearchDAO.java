...
//			stmt.setString(1,'${findbook-form.findbook}');	//?셋팅
	...
	public  List<ProductDTO> getProductSearchList(Connection conn,String findbook) throws SQLException {
		System.out.println("DAO 메소드 진입");
		String sql = "SELECT book_id,book_kind,book_title,book_price,book_count,author,publishing_com, "+
				"publishing_date,book_image,book_content,discount_rate,reg_date " + 
				"FROM product_book "+
