...
public class ProductDTO{
	//field		-- 도서 테이블 생성
		private int 	book_id;							//책아이디  primary key 번호로 적용
		private String	book_kind;  					//종류	
		...
		private String	book_content;				//책설명
		...
		public ProductDTO(int book_id, String book_kind, String book_title, int book_price, int book_count,
				String author, String publishing_com, String publishing_date, String book_image, String book_content,
				int discount_rate, LocalDate reg_date, Date date) {
			this.book_id = book_id;
			this.book_kind = book_kind;
			this.book_title = book_title;
			this.book_price = book_price;
		...
		public ProductDTO(String book_kind, String book_title, int book_price, int book_count,
				String author, String publishing_com, String publishing_date, String book_image, String book_content,
				int discount_rate) {
			this.book_kind = book_kind;
			this.book_title = book_title;
		...
		public String toString() {
			return "ProductDTO [book_id=" + book_id + ", book_kind=" + book_kind + ", book_title=" + book_title
