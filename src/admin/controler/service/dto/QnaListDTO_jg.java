...
public class QnaListDTO_jg {
	...
	//constructor
	public QnaListDTO_jg() {}

	public QnaListDTO_jg(int q_No, String id, String q_title, String q_content, Date q_regdate, Date q_modifieddate,
			int q_readcount) {
		this.q_No = q_No;
		this.id = id;
