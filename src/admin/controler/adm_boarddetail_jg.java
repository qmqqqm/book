...
import admin.service.BoardReadService_jg;
import mvc.command.CommandHandler_Mj;

//p651
//이 클래스는 글상세조회 요청을 담당하는 컨트롤러
//컨텍스트패스/article/read.do
public class adm_boarddetail_jg implements CommandHandler_Mj{
	
	private BoardReadService_jg readService = new BoardReadService_jg();
	...
	public String process(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		BoardArticleData articleData = readService.getArticle(articleNum,true);
		...
		//4.view
		return "../admin/adm_Boarddetail_jg.jsp";
	}
