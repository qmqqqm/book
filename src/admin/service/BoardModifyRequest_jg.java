...
public class BoardModifyRequest_jg {
	...
	public BoardModifyRequest_jg(String string, int no, String id, String pwd){}

	public BoardModifyRequest_jg(String userId, int articleNumber, String title, String pwd, String Hp) {
		this.userId = userId;
