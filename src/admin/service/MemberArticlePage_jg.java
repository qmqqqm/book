...
public class MemberArticlePage_jg {
		...
		private List<MemberArticle> content;//user가 보고싶은 페이지에 속한 특정범위의 게시물조회결과 
		 ...
		 */
		public MemberArticlePage_jg(int total, int currentPage, int size, List<MemberArticle> content) {
		...
		public List<MemberArticle> getContent() {
			return content;
		}
