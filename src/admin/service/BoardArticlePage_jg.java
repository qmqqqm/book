...
public class BoardArticlePage_jg {
		...
		private List<BoardArticle> content;//user가 보고싶은 페이지에 속한 특정범위의 게시물조회결과 
		 ...
		 */
		public BoardArticlePage_jg(int total, int currentPage, int size, List<BoardArticle> content) {
