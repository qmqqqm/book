...
public class StaffModifyArticleService_jg {
	
	private AdminDAO articleDAO = new AdminDAO();
	Connection conn = null;
	
	public void modify(StaffModifyRequest_jg modreq, int articleNumber,String id, String pwd, String hp) throws Exception {
