...
public class StaffArticlePage_jg {
		...
		private List<Article> content;//user가 보고싶은 페이지에 속한 특정범위의 게시물조회결과 
		 ...
		 */
		public StaffArticlePage_jg(int total, int currentPage, int size, List<Article> content) {
