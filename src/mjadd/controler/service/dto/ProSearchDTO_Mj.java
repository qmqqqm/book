package mjadd.controler.service.dto;

import java.time.LocalDate;
import java.util.Date;

public class ProSearchDTO_Mj {
	//field		-- 도서 테이블 생성
			...
			public ProSearchDTO_Mj(int book_id, String book_kind, String book_title, int book_price, int book_count,
